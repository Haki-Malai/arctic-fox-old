        ...
        <ScrollView contentContainerStyle={styles.accountScroll} horizontal={false} scrollEnabled={false}>
          <View style={styles.account}>
            <View style={styles.accountDetailsWrapper}>
              <Avatar avatar={this.props.avatar} url={this.props.url} />
            ...
            <Lang setLang={this.props.setLang} />
            ...
            <Options refreshUserData={this.props.refreshUserData} url={this.props.url} userData={this.props.userData} lang={this.props.lang} logout={() => this.props.logout()} />
          </View>
        </ScrollView>
