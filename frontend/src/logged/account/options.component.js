...
export default class Options extends React.Component {
  ...
  render () {
    ...
    if (this.state.option === 'support') {
      toExpand = <Support lang={this.props.lang} />
    } else if (this.state.option === 'guide') {
      toExpand = <Guide url={this.props.url} lang={this.props.lang} />
    } else if (this.state.option === 'password') {
      toExpand = <Password url={this.props.url} lang={this.props.lang} />
    } else if (this.state.option === 'transaction') {
      toExpand = <Transaction url={this.props.url} lang={this.props.lang} userData={this.props.userData} refreshUserData={this.props.refreshUserData} />
    }
    return (
