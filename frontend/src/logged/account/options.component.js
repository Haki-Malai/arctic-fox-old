...
export default class Options extends React.Component {
    ...
    render() {
        ...
        if (this.state.option === "support") {
            ...
            toExpand = (
                <Guide url={this.props.url} lang={this.props.lang}></Guide>
            );
        ...
        return (
            <View style={styles.accountOptions}>
                <Pressable
                    ...
                    onPress={() =>
                        this.state.option != "support"
                            ? this.setState({ option: "support" })
                            : this.setState({ option: "none" })
                    }
                >
                    <Image
                        style={styles.accountOptionPressableIcon}
                        source={require("../../../assets/account/headset.png")}
                    />
                    <Text style={styles.accountOptionPressableText}>
                        {this.props.lang === "en"
                            ? "Customer service"
                            : "Εξυπηρέτηση πελατών"}
                    </Text>
                ...
                <Pressable
                    style={styles.accountOption}
                    onPress={() =>
                        this.state.option != "guide"
                            ? this.setState({ option: "guide" })
                            : this.setState({ option: "none" })
                    }
                >
                    <Image
                        style={styles.accountOptionPressableIcon}
                        source={require("../../../assets/account/book.png")}
                    />
                    <Text style={styles.accountOptionPressableText}>
                        {this.props.lang === "en"
                            ? "User guidance"
                ...
                <Pressable
                    ...
                    onPress={() =>
                        this.state.option != "transaction"
                            ? this.setState({ option: "transaction" })
                            : this.setState({ option: "none" })
                    }
                >
                    <Image
                        style={styles.accountOptionPressableIcon}
                        source={require("../../../assets/account/bitcoin.png")}
                    />
                    <Text style={styles.accountOptionPressableText}>
                        {this.props.lang === "en"
                            ? "Transaction Options"
                ...
                >
                    <Text style={styles.accountOptionPressableText}>
                        {this.props.lang === "en" ? "Log Out" : "Αποσύνδεση"}
                    </Text>
                </Pressable>
            </View>
        );
