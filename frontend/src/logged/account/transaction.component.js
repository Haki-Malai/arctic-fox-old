            ...
            fetch(this.props.url + "payment_history", requestOptions)
                ...
                .then((data) => {
                    if (data.payments) {
                        ...
                        this.setState({
                            paymentExpanded: !this.state.paymentExpanded,
                        });
                    } else {
                        alert("Something went wrong!");
                    }
            ...
            <View style={styles.paymentContainer}>
                ...
                <View style={styles.paymentContainer}>
                    <TextInput
                        ...
                        onChangeText={(input) =>
                            this.setState({ new_address: input })
                        }
                    ></TextInput>
                    <TextInput
                    ...
                    >
                        <Text style={styles.paymentPressableText}>
                            {this.props.lang == "en"
                                ? "Change Address"
                                : "Αλλαγή Διεύθυνσης"}
                        </Text>
                ...
                <View style={styles.paymentContainer}>
                    <Pressable
                        style={styles.paymentPressableMini}
                        onPress={() => this.expandPayment()}
                    >
                        <Text style={styles.paymentPressableText}>
                            {this.props.lang == "en"
                                ? "Payment history"
                ...
                <View style={styles.paymentContainer}>
                    <Pressable
                        style={styles.paymentPressableMini}
                        onPress={() => this.expandRequests()}
                    >
                        <Text style={styles.paymentPressableText}>
                            {this.props.lang == "en"
                                ? "Unpaid requests"
                                : "Μη πληρωμένες αιτήσεις"}
                        </Text>
                    </Pressable>
                    {requestHistory}
                </View>
