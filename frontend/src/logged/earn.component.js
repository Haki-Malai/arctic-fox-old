        ...
        if (this.state.media === "none") {
            ...
            main = (
                <View style={styles.container}>
                    ...
                    <Level
                        userData={this.props.userData}
                        lang={this.props.lang}
                        level={this.state.page}
                        value={this.props.level[this.state.page - 1][0]}
                        daily={this.props.level[this.state.page - 1][1]}
                        buy={this.props.level[this.state.page - 1][2]}
                    ></Level>
                    {media}
                    <Navigator
                        lang={this.props.lang}
            ...
            main = (
                <View style={styles.container}>
                    ...
                    <Tasks
                        url={this.props.url}
                        title={this.state.media}
                        lang={this.props.lang}
                        plus={this.props.level[this.state.page - 1][0]}
                        userData={this.props.userData}
                        setMedia={this.setMedia}
                    ></Tasks>
                    <Navigator
