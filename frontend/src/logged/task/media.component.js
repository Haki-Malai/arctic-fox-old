...
export default class Media extends React.Component {
    ...
    render() {
        ...
        this.props.mkey & 1
            ? mediaStyles.push(styles.mediaA)
            : mediaStyles.push(styles.mediaB);
                ...
                <View style={mediaStyles}>
                    <View style={styles.upload}>
                        ...
                        <Text style={styles.uploadLinkText}>
                            Task: {this.props.data.vulnerability}
                        </Text>
                        <Pressable style={styles.uploadLink}>
                            <Text
                                style={styles.uploadLinkText}
                                onPress={() =>
                                    this.loadInBrowser(this.props.data.url)
                                }
                            >
